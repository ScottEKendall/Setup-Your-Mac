...
welcomeDialog="${6:-"false"}"                                                   # Parameter 6: Welcome dialog [ userInput (default) | video | messageOnly | false ]="${6:-"userInput"}"                                               # Parameter 6: Welcome dialog [ userInput (default) | video | messageOnly | false ]
